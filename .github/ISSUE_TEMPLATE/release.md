...
- [ ] Update the `baseBranches` list in renovate's configuration file, `.github/renovate.json`, with the new release branch, removing the old unsupported release one.
