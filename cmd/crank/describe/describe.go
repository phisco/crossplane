...
import (
	...
	"github.com/crossplane/crossplane/cmd/crank/describe/internal/printer"
...
// Cmd describes a Kubernetes Crossplane resource.
type Cmd struct {
	Resource string `arg:"" required:"" help:"'TYPE[.VERSION][.GROUP] [NAME]' or 'TYPE[.VERSION][.GROUP]/NAME' identifying the Crossplane resource." placeholder:""`
	// Name kept hidden to support passing it as positional argument, similar to kubectl get
	Name string `arg:"" hidden:"" optional:""`
...
func (c *Cmd) Run(logger logging.Logger) error {
	logger = logger.WithValues("Kind", c.Resource, "Name", c.Name)
